function Test-ModuleVersion {
    process {
        ...
        $installedVersion = (get-installedmodule -Name Smtp4Dev4BcContainers | Sort-Object -Property Version | Select-Object -Last 1).Version #$MyInvocation.MyCommand.Module.Version does not work while module loading
